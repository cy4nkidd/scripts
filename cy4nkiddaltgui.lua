...
local ecy4nkiddMessage = Instance.new("TextButton")
local ecy4nkiddMusic = Instance.new("TextButton")
local ecy4nkiddLaugh = Instance.new("TextButton")
...
Credits.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
Credits.Position = UDim2.new(0, 0, 0.912, 0)
Credits.Size = UDim2.new(0, 378, 0, 22)
Credits.Font = Enum.Font.GothamBold
Credits.Text = "By cy4nkidd"
Credits.TextColor3 = Color3.fromRGB(0, 0, 0)
Credits.TextScaled = true
Credits.TextSize = 14.000
Credits.TextWrapped = true

ecy4nkiddMessage.Name = "ecy4nkiddMessage"
ecy4nkiddMessage.Parent = Frame
ecy4nkiddMessage.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
ecy4nkiddMessage.Position = UDim2.new(0.0714285746, 0, 0.216000006, 0)
ecy4nkiddMessage.Size = UDim2.new(0, 79, 0, 31)
ecy4nkiddMessage.Font = Enum.Font.GothamBold
ecy4nkiddMessage.Text = "cy4nkidd Message"
ecy4nkiddMessage.TextColor3 = Color3.fromRGB(0, 0, 0)
ecy4nkiddMessage.TextScaled = true
ecy4nkiddMessage.TextSize = 14.000
ecy4nkiddMessage.TextWrapped = true
ecy4nkiddMessage.MouseButton1Down:connect(function()
	while true do
		wait(12)--set this to how much time between messages
		msg = Instance.new ("Hint")
		msg.Parent = game.Workspace
		msg.Text = "cy4nkidd: MUHAWHAWHAW! NOOBS! I HAVE RETURNED FOR MY REVENGE!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "cy4nkidd: NOW YOU WILL ALL PARISH IN MY FIRE OF DOOM!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "cy4nkidd: I WILL DESTROY YOU ALL! YOU ARE WORTHLESS!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "cy4nkidd: YOU WILL NOT LIVE THROUGH MY DEADLY ATTACKS!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "cy4nkidd: I MIGHT AS WELL CLONE YOU INTO BOTS!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "cy4nkidd: AND THEN THOSE BOTS WILL DESTROY ROBLOX! HAHAHAHAHA!"
		wait(6)
		msg:remove()
		wait(3)
		msg = Instance.new("Message")
		msg.Parent = game.Workspace
		msg.Text = "cy4nkidd: YOU CAN'T STOP ME! THERES NOTHING YOU CAN DO!"
		wait(6)
		msg:remove()
	end
end)
ecy4nkiddMusic.Name = "ecy4nkiddMusic"
ecy4nkiddMusic.Parent = Frame
ecy4nkiddMusic.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
ecy4nkiddMusic.Position = UDim2.new(0.0714285746, 0, 0.436000019, 0)
ecy4nkiddMusic.Size = UDim2.new(0, 79, 0, 31)
ecy4nkiddMusic.Font = Enum.Font.GothamBold
ecy4nkiddMusic.Text = "cy4nkidd Music"
ecy4nkiddMusic.TextColor3 = Color3.fromRGB(0, 0, 0)
ecy4nkiddMusic.TextScaled = true
ecy4nkiddMusic.TextSize = 14.000
ecy4nkiddMusic.TextWrapped = true
ecy4nkiddMusic.MouseButton1Down:connect(function()
	--Made by Servano
...
ecy4nkiddLaugh.Name = "ecy4nkiddLaugh"
ecy4nkiddLaugh.Parent = Frame
ecy4nkiddLaugh.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
ecy4nkiddLaugh.Position = UDim2.new(0.0714285746, 0, 0.648000002, 0)
ecy4nkiddLaugh.Size = UDim2.new(0, 79, 0, 34)
ecy4nkiddLaugh.Font = Enum.Font.GothamBold
ecy4nkiddLaugh.Text = "cy4nkidd Laugh"
ecy4nkiddLaugh.TextColor3 = Color3.fromRGB(0, 0, 0)
ecy4nkiddLaugh.TextScaled = true
ecy4nkiddLaugh.TextSize = 14.000
ecy4nkiddLaugh.TextWrapped = true
ecy4nkiddLaugh.MouseButton1Down:connect(function()
	--Made by Servano
...
DayToNight.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
e666.Name = "e666"
e666.Parent = Frame
e666.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
EpicSaxGuy.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
Disc0.Name = "Disc0"
Disc0.Parent = Frame
Disc0.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
e2006Theme.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
ForceField.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
