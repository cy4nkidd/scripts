...
local skyboxID = game.Players.LocalPlayer.PlayerGui.cy4ngui.Frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = 11499174200	
	end)
--
local button = Instance.new("TextButton")
	button.Parent = psd
...
local button = Instance.new("TextButton")
	...
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = 11732302586	
	end)
--
local button = Instance.new("TextButton")
	button.Parent = psd
