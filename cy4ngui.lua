...
page = Instance.new("Frame")
    ...
    right.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
left = Instance.new("TextButton")
    ...
    left.BorderColor3 = Color3.fromRGB(0, 255, 255)
    left.BorderSizePixel = 3
    left.Position = UDim2.new(0, 0, 0, 40)
    left.Size = UDim2.new(0.5, 0, 0, 40)
    left.ZIndex = 2
...
local acg = Instance.new("Frame")
    ...
    acg.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local sd = Instance.new("Frame")
    ...
    sd.BorderColor3 = Color3.fromRGB(0, 255, 255)
    sd.BorderSizePixel = 3
    sd.Size = UDim2.new(0.5, 0, 1, 0)
    sd.ZIndex = 2
local gt = Instance.new("Frame")
    gt.Name = "Gear/Tools"
    gt.Parent = page2
    gt.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    gt.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local ws = Instance.new("Frame")
    ...
    ws.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local localp = Instance.new("Frame")
    ...
    localp.BorderColor3 = Color3.fromRGB(0, 255, 255)
    localp.BorderSizePixel = 3
    localp.Size = UDim2.new(0.5, 0, 1, 0)
    localp.ZIndex = 2
...
local psd = Instance.new("Frame")
    ...
    psd.BorderColor3 = Color3.fromRGB(0, 255, 255)
    psd.BorderSizePixel = 3
    psd.Size = UDim2.new(0.5, 0, 1, 0)
    psd.ZIndex = 2
...
local pgi = Instance.new("Frame")
    ...
    pgi.BorderColor3 = Color3.fromRGB(0, 255, 255)
    pgi.BorderSizePixel = 3
    pgi.Size = UDim2.new(0.5, 0, 1, 0)
    pgi.ZIndex = 2
local PageLabel_3 = Instance.new("TextLabel")
    PageLabel_3.Name = "PageLabel"
    PageLabel_3.Parent = page5
    PageLabel_3.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    PageLabel_3.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local PageLabel_4 = Instance.new("TextLabel")
    ...
    PageLabel_4.Parent = page4
    PageLabel_4.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    PageLabel_4.BorderColor3 = Color3.fromRGB(0, 255, 255)
    PageLabel_4.BorderSizePixel = 3
    PageLabel_4.Position = UDim2.new(0, 0, 1, -30)
    PageLabel_4.Size = UDim2.new(1, 0, 0, 30)
    PageLabel_4.ZIndex = 2
    PageLabel_4.Font = Enum.Font.SourceSans
    PageLabel_4.Text = "Page 4"
...
local PageLabel_5 = Instance.new("TextLabel")
    ...
    PageLabel_5.Parent = page3
    PageLabel_5.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    PageLabel_5.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local PageLabel_6 = Instance.new("TextLabel")
    ...
    PageLabel_6.Parent = page2
    PageLabel_6.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    PageLabel_6.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local PageLabel_7 = Instance.new("TextLabel")
    ...
    PageLabel_7.Parent = page1
    PageLabel_7.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    PageLabel_7.BorderColor3 = Color3.fromRGB(0, 255, 255)
    PageLabel_7.BorderSizePixel = 3
    PageLabel_7.Position = UDim2.new(0, 0, 1, -29)
    PageLabel_7.Size = UDim2.new(1, 0, 0, 29)
    PageLabel_7.ZIndex = 2
    PageLabel_7.Font = Enum.Font.SourceSans
    PageLabel_7.Text = "Page 1"
...
Services.Players.LocalPlayer.Chatted:connect(function(msg)
	...
	--
local button = Instance.new("TextButton")
	button.Name = "DZR Spawn Item Gui"
	button.Parent = acg
	button.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
	button.BorderColor3 = Color3.fromRGB(0, 255, 255)
	button.BorderSizePixel = 3
	...
	button.ZIndex = 2
	button.Font = Enum.Font.SourceSans
	button.Text = "DZR Spawn Item Gui"
	button.TextColor3 = Color3.fromRGB(255, 255, 255)
	button.TextSize = 14.000
	button.TextWrapped = true
local button = Instance.new("TextButton")
...
local button = Instance.new("TextButton")
	...
	button.ZIndex = 2
	button.Font = Enum.Font.SourceSans
	button.Text = "Quikscope Gui"
	button.TextColor3 = Color3.fromRGB(255, 255, 255)
	button.TextSize = 14.000
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
local function RWAVMWJ_fake_script() -- QuickscopeGui.Script 
	local script = Instance.new('Script', QuickscopeGui)
	...
	play.Character.Head:Remove()
	g = script.Gui:Clone()
	g.Parent = play.PlayerGui
	g.TrippyCam.Disabled = false
	g.dabstep.Disabled = false
	g.stoper.Disabled = false
	g.Frame.LocalScript.Disabled = false
	g.Frame.Visible = true
	g.TextLabel.Visible = true
	g.ImageLabel.Visible = true
	g.TextLabel.LocalScript.Disabled = false
	bu.Text = "Quickscoped!"
	wait(2)
	bu.Text = a[i].Name
	end
...
coroutine.wrap(RWAVMWJ_fake_script)()
-- TextLabel.LocalScript is disabled.
-- Frame.LocalScript is disabled.
-- Gui.TrippyCam is disabled.
-- Gui.dabstep is disabled.
-- Gui.stoper is disabled.
local function QYUAPS_fake_script() -- ImageLabel.LocalScript 
...
coroutine.wrap(QYUAPS_fake_script)()
local function VJFCVI_fake_script() -- dew.LocalScript 
	local script = Instance.new('LocalScript', dew)
...
local skyboxID = game.CoreGui.cy4ngui.Frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text
...
local button = Instance.new("TextButton")
	...
	button.TextColor3 = whit
	button.MouseButton1Down:connect(function()
local function TVINJ_fake_script() -- Minigun.LocalScript 
...
coroutine.wrap(TVINJ_fake_script)()
	end)
--
local button = Instance.new("TextButton")
	button.Parent = gt
...
local Drage = Instance.new("TextButton")
    Drage.Name = "Drage"
    Drage.Parent = ws
    Drage.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Drage.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local DualBlades = Instance.new("TextButton")
    ...
    DualBlades.Parent = ws
    DualBlades.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    DualBlades.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local Eyelaser = Instance.new("TextButton")
    ...
    Eyelaser.Parent = ws
    Eyelaser.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Eyelaser.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local Knife = Instance.new("TextButton")
    Knife.Name = "Knife"
    Knife.Parent = ws
    Knife.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Knife.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local Lance = Instance.new("TextButton")
    Lance.Name = "Lance"
    Lance.Parent = ws
    Lance.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Lance.BorderColor3 = Color3.fromRGB(0, 255, 255)
    ...
    Lance.Text = "Lance"
    Lance.TextColor3 = Color3.fromRGB(255, 255, 255)
    Lance.TextSize = 14.000
...
local Lightsaber = Instance.new("TextButton")
    ...
    Lightsaber.Parent = ws
    Lightsaber.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Lightsaber.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local MasterHand = Instance.new("TextButton")
    ...
    MasterHand.Parent = ws
    MasterHand.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    MasterHand.BorderColor3 = Color3.fromRGB(0, 255, 255)
    ...
    MasterHand.TextColor3 = Color3.fromRGB(255, 255, 255)
    MasterHand.TextSize = 14.000
    MasterHand.TextWrapped = true
	 	MasterHand.MouseButton1Down:connect(function()
...
local Plane = Instance.new("TextButton")
    Plane.Name = "Plane"
    Plane.Parent = ws
    Plane.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Plane.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local Snowball = Instance.new("TextButton")
    ...
    Snowball.Parent = ws
    Snowball.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Snowball.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local Staff = Instance.new("TextButton")
    Staff.Name = "Staff"
    Staff.Parent = ws
    Staff.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Staff.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local SuicideVest = Instance.new("TextButton")
    ...
    SuicideVest.Parent = ws
    SuicideVest.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    SuicideVest.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local TechnoGauntlet = Instance.new("TextButton")
    ...
    TechnoGauntlet.Parent = ws
    TechnoGauntlet.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    TechnoGauntlet.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local Wand = Instance.new("TextButton")
    Wand.Name = "Wand"
    Wand.Parent = ws
    Wand.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Wand.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local xBow = Instance.new("TextButton")
    xBow.Name = "xBow"
    xBow.Parent = ws
    xBow.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    xBow.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "Team cy4nkidd Logo 1"
	button.Position = UDim2.new(0,0,0,33)
	button.Size = UDim2.new(0.5,0,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Team cy4nkidd Logo 1"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = 11451842484	
	end)
--
local button = Instance.new("TextButton")
	button.Parent = psd
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "Team cy4nkidd Logo 2"
	button.Position = UDim2.new(0.5,3,0,33)
	button.Size = UDim2.new(0.5,-3,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "Team cy4nkidd Logo 2"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = 11880323109	
	end)
--
local button = Instance.new("TextButton")
	button.Parent = psd
...
local button = Instance.new("TextButton")
	...
	button.BorderColor3 = rede
	button.BorderSizePixel = 3
	button.Name = "cy4nkidd"
	button.Position = UDim2.new(0.5,3,0,66)
	button.Size = UDim2.new(0.5,-3,0,30)
	button.ZIndex = 2
	button.Font = tef
	button.FontSize = "Size14"
	button.Text = "cy4nkidd"
	button.TextColor3 = whit
	button.TextWrapped = true
	button.MouseButton1Down:connect(function()
	frame.Settings.Page1["Skybox/Decal ID"].TextBox.Text = 11858812858	
	end)
--
...
local Title_24 = Instance.new("TextLabel")
    Title_24.Name = "Title"
    Title_24.Parent = pgi
    Title_24.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Title_24.BorderColor3 = Color3.fromRGB(0, 255, 255)
    Title_24.BorderSizePixel = 3
    Title_24.Size = UDim2.new(1, 0, 0, 30)
    Title_24.ZIndex = 2
    Title_24.Font = Enum.Font.SourceSansBold
    Title_24.Text = "Preset Gear IDs"
    Title_24.TextColor3 = Color3.fromRGB(255, 255, 255)
    Title_24.TextSize = 14.000
...
local DualDarkhearts = Instance.new("TextButton")
    ...
    DualDarkhearts.Parent = pgi
    DualDarkhearts.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    DualDarkhearts.BorderColor3 = Color3.fromRGB(0, 255, 255)
    ...
    DualDarkhearts.TextColor3 = Color3.fromRGB(255, 255, 255)
    DualDarkhearts.TextSize = 14.000
...
local DualVenomshanks = Instance.new("TextButton")
    ...
    DualVenomshanks.Parent = pgi
    DualVenomshanks.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    DualVenomshanks.BorderColor3 = Color3.fromRGB(0, 255, 255)
    ...
    DualVenomshanks.TextColor3 = Color3.fromRGB(255, 255, 255)
    DualVenomshanks.TextSize = 14.000
    DualVenomshanks.TextWrapped = true
	DualVenomshanks.MouseButton1Down:connect(function()
...
local GhostfireSword = Instance.new("TextButton")
    ...
    GhostfireSword.Parent = pgi
    GhostfireSword.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    GhostfireSword.BorderColor3 = Color3.fromRGB(0, 255, 255)
    ...
    GhostfireSword.TextColor3 = Color3.fromRGB(255, 255, 255)
    GhostfireSword.TextSize = 14.000
    GhostfireSword.TextWrapped = true
	GhostfireSword.MouseButton1Down:connect(function()
...
local GravityCoil = Instance.new("TextButton")
    ...
    GravityCoil.Parent = pgi
    GravityCoil.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    GravityCoil.BorderColor3 = Color3.fromRGB(0, 255, 255)
    ...
    GravityCoil.TextColor3 = Color3.fromRGB(255, 255, 255)
    GravityCoil.TextSize = 14.000
...
local Hyperbike = Instance.new("TextButton")
    ...
    Hyperbike.Parent = pgi
    Hyperbike.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Hyperbike.BorderColor3 = Color3.fromRGB(0, 255, 255)
    ...
    Hyperbike.TextColor3 = Color3.fromRGB(255, 255, 255)
    Hyperbike.TextSize = 14.000
...
local Icedagger = Instance.new("TextButton")
    ...
    Icedagger.Parent = pgi
    Icedagger.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    Icedagger.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local LinkedSword = Instance.new("TextButton")
    ...
    LinkedSword.Parent = pgi
    LinkedSword.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    LinkedSword.BorderColor3 = Color3.fromRGB(0, 255, 255)
    ...
    LinkedSword.TextColor3 = Color3.fromRGB(255, 255, 255)
    LinkedSword.TextSize = 14.000
    LinkedSword.TextWrapped = true
	LinkedSword.MouseButton1Down:connect(function()
...
local Save = Instance.new("TextButton")
    ...
    Save.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local Load = Instance.new("TextButton")
    ...
    Load.BorderColor3 = Color3.fromRGB(0, 255, 255)
...
local PageLabel = Instance.new("TextLabel")
    ...
    PageLabel.Parent = pge2
    PageLabel.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    PageLabel.BorderColor3 = Color3.fromRGB(0, 255, 255)
    PageLabel.BorderSizePixel = 3
    PageLabel.Position = UDim2.new(0, 0, 1, -53)
...
local PageLabel_2 = Instance.new("TextLabel")
    ...
    PageLabel_2.Parent = pge1
    PageLabel_2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    PageLabel_2.BorderColor3 = Color3.fromRGB(0, 255, 255)
    PageLabel_2.BorderSizePixel = 3
    PageLabel_2.Position = UDim2.new(0, 0, 1, -52)
    PageLabel_2.Size = UDim2.new(1, 0, 0, 29)
    PageLabel_2.Font = Enum.Font.SourceSans
    PageLabel_2.Text = "Page 1"
...
local arr = Instance.new("Frame")
	...
	arr.Position = UDim2.new(0,0,0,66)
...
local cst = Instance.new("Frame")
	...
	cst.Position = UDim2.new(0.5,3,0,66)
...
local lsn = Instance.new("Frame")
	...
	lsn.Position = UDim2.new(0,0,0,132)
...
local nmb = Instance.new("Frame")
	...
	nmb.Name = "Name Box"
	nmb.Position = UDim2.new(0.5,3,0,0)
...
local wsa = Instance.new("Frame")
	...
	wsa.Position = UDim2.new(0,0,0,198)
...
local textbx = Instance.new("TextBox")
	...
	local titl = Instance.new("TextLabel")
		...
		titl.Font = tef.."Bold"
		titl.FontSize = "Size14"
		titl.Text = "Anti Robloxian Range"
		titl.TextColor3 = whit
		titl.TextWrapped = true
...
local textbx = Instance.new("TextBox")
		...
		textbx.Font = tef
		textbx.FontSize = "Size14"
		textbx.Text = "Join team cy4nkidd!"
		textbx.TextColor3 = whit
	local titl = Instance.new("TextLabel")
		titl.Parent = cst
		titl.BackgroundColor3 = blak
...
-----------------------------------------------------------------------------
	...
	s.Text = "cy4ngui Reborn V1.1 has loaded."
	wait(3)
	s:Remove()